...
%description devel
compute the ambient metrics of each location, based on their sensors metrics development tools
This package contains development files for fty-metric-ambient-location: compute the ambient metrics of each location, based on their sensors metrics

%files devel
%defattr(-,root,root)
%{_includedir}/*
%{_libdir}/libfty_metric_ambient_location.so
%{_libdir}/pkgconfig/libfty_metric_ambient_location.pc
%{_mandir}/man3/*
%{_mandir}/man7/*
